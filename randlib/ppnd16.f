...
C
C	ALGORITHM AS241  APPL. STATIST. (1988) VOL. 37, NO. 3, 477-484.
C
...
C	transcription.
C
C     The Royal Statistical Society holds the copyright to these routines, 
C     but has given its permission for their distribution provided that 
C     no fee is charged. 
C
